...
\lstdefinelanguage{Bash}{
    keywords={if, then, else, elif, fi, case, esac, for, select, while, until, do, done, in, function},
    keywordstyle=\color{blue}\bfseries,
    ndkeywords={echo, exit, return, export, source, alias, unalias},
    ndkeywordstyle=\color{darkgray}\bfseries,
    identifierstyle=\color{black},
    sensitive=true,
    comment=[l]{\#},
...
% Set JavaScript listings options
...
\chapter[\Large Introducción]{\LARGE Introducción, Antecedentes y Estado del Arte}
\label{chapter:intro}
